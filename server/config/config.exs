...
config :instagram, InstagramWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "w7QMEl/N0RCDjZ8xzu7n1Nd7cXp1zQXH0/MEaDBSaCEQPm6/+WG5wwiQD5LB3IxY",
  render_errors: [view: InstagramWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Instagram.PubSub,
  live_view: [signing_salt: "ImK8ioa6"]
...
config :instagram, InstagramWeb.Auth.Guardian,
  issuer: "instagram",
  verify_issuer: true,
  secret_key: "PQht5EnsbB0LAtdS53wiM5Ya95+GhTgZoAxn27QmpRyiSAf9i7LuAUSQx+86ctrj"
